Create a senior-grade, production-ready React and Tailwind CSS UI component for "ECCO".

### Design & Aesthetic Guidelines:
- Title: ECCO
- Concept: Minimal outdoor footwear concept — Stay in control. Feel the freedom.
