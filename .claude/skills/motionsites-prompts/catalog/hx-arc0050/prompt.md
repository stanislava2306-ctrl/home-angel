Create a senior-grade, production-ready React and Tailwind CSS UI component for "ARC0050".

### Design & Aesthetic Guidelines:
- Title: ARC0050
- Concept: Interactive React + Three.js explorer for a 50-floor commercial high-rise.
