Create a senior-grade, production-ready React and Tailwind CSS UI component for "Oppo".

### Design & Aesthetic Guidelines:
- Title: Oppo
- Concept: A vibrant Oppo Enco landing page concept for wireless earbuds.
