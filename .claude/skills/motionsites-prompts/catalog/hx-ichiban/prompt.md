Create a senior-grade, production-ready React and Tailwind CSS UI component for "ICHIBAN".

### Design & Aesthetic Guidelines:
- Title: ICHIBAN
- Concept: Product landing for a futuristic electric motorcycle with bold purple branding
