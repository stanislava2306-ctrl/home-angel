...
контекст детства (полная ли семья, порядок рождения, атмосфера дома) и все 55 ответов,
включая собственные формулировки человека в незаконченных предложениях. Если currentState
