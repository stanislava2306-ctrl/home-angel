...
внутренний критик, контроль как защита, эмоциональная закрытость, гиперответственность),
три дополнительных (extraPatterns: страх отвержения, недоверие, недолюбленность), оценку
текущего состояния (currentState: low/mid/high — high значит, что человеку сейчас тяжело),
контекст детства (полная ли семья, порядок рождения, атмосфера дома) и все 56 ответов,
включая собственные формулировки человека в незаконченных предложениях и три слова,
выбранные им за 20 секунд (type "words") — это первый импульс, обращай на него внимание. Если currentState
high — начни с бережного признания текущего состояния.
